...
// */
//
//package com.dashidan.data.source;
//
//import com.dashidan.GetTaskCallback;
//import com.dashidan.LoadTasksCallback;
//import com.dashidan.data.FakeTasksRemoteDataSource;
...
//
//    @Mock
//    private FakeTasksRemoteDataSource mTasksRemoteDataSource;
//
//    @Mock
//    private TasksLocalDataSource mTasksLocalDataSource;
//
//    @Mock
//    private GetTaskCallback mGetTaskCallback;
//
//    @Mock
...
//     */
//    @Captor
//    private ArgumentCaptor<LoadTasksCallback> mTasksCallbackCaptor;
//
//    /**
//     * {@link ArgumentCaptor} is a powerful Mockito API to capture argument values and use them to
//     * perform further actions or assertions on them.
//     */
//    @Captor
//    private ArgumentCaptor<GetTaskCallback> mTaskCallbackCaptor;
//
//    @Before
...
//        verify(mTasksRemoteDataSource).getTasks(any(LoadTasksCallback.class));
//    }
//
//    @Test
...
//        verify(mTasksLocalDataSource).getTasks(any(LoadTasksCallback.class));
//    }
//
//    @Test
...
//     */
//    private void twoTasksLoadCallsToRepository(LoadTasksCallback callback) {
