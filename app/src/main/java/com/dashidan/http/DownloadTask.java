...
//                ((TasksActivity) context).updateFromDownload(null);
    ...
    protected Result doInBackground(String... urls) {
        ...
        if (!isCancelled() && urls != null && urls.length > 0) {
            ...
            try {
                ...
                ArrayList<String> resultString = downloadUrl(url);
     ...
     */
    private ArrayList<String> downloadUrl(URL url) throws IOException {
        ...
        try {
            ...
            connection.connect();
            publishProgress(Progress.CONNECT_SUCCESS);
            ...
            if (stream != null) {
                ...
                publishProgress(Progress.PROCESS_INPUT_STREAM_SUCCESS, 0);
            }
        } finally {
    ...
    private String readStream(InputStream stream, int maxLength) throws IOException {
        ...
        while (numChars < maxLength && readSize != -1) {
            ...
            publishProgress(Progress.PROCESS_INPUT_STREAM_IN_PROGRESS, pct);
    ...
    private ArrayList<String> getStringFromInputStream(InputStream is) {
